...
function createToken(staff) {
    return jwt.sign({ id: staff.id, first_name: staff.first_name, last_name: staff.last_name, isAdmin: staff.isAdmin, company: staff.company }, config.jwtSecret, {
        expiresIn: 3600000
    });
}
...
let StaffController = {
    register: async (req,res) => {
        ...
        company = req.params;
        id = company.id;
        const { username, first_name, last_name, isAdmin, isReception, isEntrance, isStaff, password} = req.body;
    ...
    edit: async (req,res) => {
        ...
        Staff.findById(id, function(err, staff) {
            ...
            staff.isReception = req.body.isReception;
            staff.isEntrance = req.body.isEntrance;
            staff.isStaff = req.body.isStaff;
